...
def imread(filename: str, flags: int = cv2.IMREAD_COLOR, augment: bool = False) -> Optional[np.ndarray]:
    """
    ...
    Args:
        ...
        augment (bool, optional): Whether to augment the image during 16 -> 8 bit conversion.
